    ...
    <div class="register span12 form_login">
      <div class="area">
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <?php
               echo $this->Form->input('User.email', array('label'=>false, 'placeholder' => 'email@email.com'));
            ?>
          </div>
        </div>
        <div class="control-group">
          ...
          <div class="controls">
            <?php
               echo $this->Form->input('User.nome', array('label'=>false, 'placeholder' => 'Nome'));
            ?>
          </div>
        </div>
        <div class="control-group">
          ...
          <div class="controls">
            <?php
               echo $this->Form->input('User.password', array('label'=>false, 'placeholder' => 'senha'));
            ?>
          </div>
        </div>
        <div class="control-group">
        ...
        <div class="control-group">
          ...
          <div class="controls">
          <?php
            echo $this->Form->input('User.notification_level',
                                array(
                                    'options' =>
                                    array(
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <?php
                echo $this->Form->input('User.role',
                                    array('options' => array(
                                            'admin' => 'Admin',
                                            'author' => 'Colaborador'),
                                   'label' => false));
