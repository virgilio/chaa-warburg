...
var loadslider = function (min, max, inicio, fim){
    jQuery.slider = jQuery("#slider-range").slider({
                                                       range: true,
                                                       min: min,
                                                       max: max,
                                                       values: [ inicio, fim ],
                                                       slide: function( event, ui ) {
                                                           jQuery( "#intervalo" ).val( "de " + ui.values[0] + (acdc(ui.values[0])) + " a " + ui.values[1] + (acdc(ui.values[1])));
                                                           jQuery("#int-inicio").val(ui.values[0]);
                                                           jQuery("#int-fim").val(ui.values[1]);        
                                                       },
                                                       create: function(event, ui){
                                                           jQuery( "#intervalo" ).val( "de " + inicio + (acdc(inicio)) + " a " + fim + (acdc(fim)));
                                                       }
                                                   });
    jQuery("#int-inicio").val(jQuery("#slider-range").slider( "values", 0 )).change(function(){
    ...
    jQuery("#int-fim").val(jQuery("#slider-range").slider( "values", 1 )).change(function(){
